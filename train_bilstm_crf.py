...
from finlp.train.lstm_crf_trainer import LstmCrfTrainer
...
def main():
    ...
    trainer = LstmCrfTrainer(train_loader.loader, dev_loader.loader, test_loader.loader, tokenizer, tag2id, id2tag)
    trainer.train()
    trainer.test()
